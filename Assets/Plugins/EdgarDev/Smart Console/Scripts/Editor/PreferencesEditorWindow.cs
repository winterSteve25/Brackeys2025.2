...
namespace ED.SC.Editor
{
	public class PreferencesEditorWindow : EditorWindow
	{
		...
		private GUIContent k_GlobalTMPFontContent = new GUIContent("Global Font", "This represents the TextMesh Pro font used in the Smart Console.");
		...
		// Begin settings
		private TMP_FontAsset m_GlobalTMPFont;
		...
		private static Texture2D m_Icon; // Always try to copy m_SmartConsoleIcon value

		private void OnEnable()
		{
			minSize = new Vector2(504, 704);

			if (m_SmartConsoleIcon == null)
			{
				m_Icon = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/Plugins/EdgarDev/Smart Console/Sprites/SmartConsoleLogo.png");
			...
			{
				m_Preferences = AssetDatabase.LoadAssetAtPath<SmartConsolePreferences>("Assets/Plugins/EdgarDev/Smart Console/Data/SC.Prefs.asset");
		...
		private void OnGUI()
		{
			...
			m_GlobalTMPFont = (TMP_FontAsset)EditorGUILayout.ObjectField(k_GlobalTMPFontContent, m_GlobalTMPFont, typeof(TMP_FontAsset), false);
		...
		private void LoadPreferences()
		{
			...
			m_GlobalTMPFont = m_Preferences.GlobalFont;
		...
		{
			m_Preferences.GlobalFont = m_GlobalTMPFont;

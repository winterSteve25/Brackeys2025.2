...
namespace ED.SC.Demo
{
	public class DemoTutorial : MonoBehaviour
	{
		...
		private void Awake()
		{
			m_ConsoleSystem.ShowApplicationLogs = false;
		}
		...
		private void StartTutorial()
		{
			...
			m_ConsoleSystem.ShowApplicationLogs = true;
		...
		private IEnumerator TutorialToggleCoroutine()
		{
			...
			SmartConsole.Log("Try to toggle the console using the input key <b>Escape</b>.");
		...
		private IEnumerator TutorialSpinCubeCoroutine()
		{
			...
			yield return new WaitForSeconds(2.0f);
			SmartConsole.Log("Now try to spin it using the command <b>spin_last_cube</b>, don't forget to add the <i>spinCount</i> parameter!");
		...
		private IEnumerator TutorialDestroyCubeCoroutine()
		{
			...
			yield return new WaitForSeconds(2.0f);
			SmartConsole.Log("To end, try to destroy the cube index 0 using the command <b>destroy_cube_index</b>, don't forget to add the <i>index</i> parameter!");
